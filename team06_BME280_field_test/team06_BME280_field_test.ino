...
#define BATTERY 39      //バッテリー電圧を測るビン
...
void loop(){
  ...
  bme_get();   //順序入れかえ
  //電池電圧測定
  vbat = (analogRead(BATTERY) / 4095.0 * 3.3 + 0.1132) * 2.0;
  //電池電圧表示
...
void bme_get(){ 
  ...
  Serial.print("vbat = "); Serial.println(vbat_c);
  Serial.println("-----------------------");
